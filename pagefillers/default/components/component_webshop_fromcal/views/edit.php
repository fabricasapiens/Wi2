...
<div id="<?php echo $prefix; ?>_edit_tabs">
	<ul>
		<li><a href="#<?php echo $prefix; ?>_edit_tabs-1">Nieuwe activiteit</a></li>
	...
	<div id="<?php echo $prefix; ?>_edit_tabs-1">
        ...
        <h2>Nieuwe activiteit</h2><p>
                ...
                <tr><td> volledige tekst </td><td> <textarea name='fullText' 'componentInput_tinyMCE' /></td></tr>
                <?php
                    // -----------------------------------
