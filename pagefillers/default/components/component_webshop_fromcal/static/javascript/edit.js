...
wi3.makeExist("wi3.pagefiller.components.component_calendar");
//now add our funtion(s) to this existing object(s)


wi3.pagefiller.components.component_calendar.initedit = function() {
    var prefix = "component_calendar";
...
wi3.pagefiller.components.component_calendar.add = function() {
    var prefix = "component_calendar";
...
wi3.pagefiller.components.component_calendar.edit = function(id) {
    var prefix = "component_calendar";
    //show the edit form
...
wi3.pagefiller.components.component_calendar.saveedit = function(id) {
    var prefix = "component_calendar";
    //check for TinyMCE instances
...
wi3.pagefiller.components.component_calendar.moveup = function(elm) {
    var prefix = "component_calendar";
...
wi3.pagefiller.components.component_calendar.movedown = function(elm) {
    var prefix = "component_calendar";
    var parent = $(elm).closest("tr");
...
wi3.pagefiller.components.component_calendar.remove = function(id) {
    var prefix = "component_calendar";
