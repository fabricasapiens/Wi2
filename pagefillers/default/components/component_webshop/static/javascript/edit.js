...
wi3.pagefiller.components.component_webshop.initedit = function() {
    var prefix = "component_webshop";
    $("#" + prefix + "_edit_tabs").tabs();
    $("#" + prefix + "_article_tabs").tabs(); //enable webshop article-selector
...
wi3.pagefiller.components.component_webshop.savesettings = function() {
    var prefix = "component_webshop";
    wi3.request(prefix + "/savesettings/" + wi3.pagefiller.editing.currentFieldId, $("#" + prefix + "_settings").serializeArray() );
    return false;
}  

wi3.pagefiller.components.component_webshop.add = function() {
    var prefix = "component_webshop";
...
wi3.pagefiller.components.component_webshop.edit = function(id) {
    var prefix = "component_webshop";
    //show the edit form
...
wi3.pagefiller.components.component_webshop.saveedit = function(id) {
    var prefix = "component_webshop";
    //check for TinyMCE instances
...
wi3.pagefiller.components.component_webshop.moveup = function(elm) {
    var prefix = "component_webshop";
...
wi3.pagefiller.components.component_webshop.movedown = function(elm) {
    var prefix = "component_webshop";
    var parent = $(elm).closest("tr");
...
wi3.pagefiller.components.component_webshop.remove = function(id) {
    var prefix = "component_webshop";
