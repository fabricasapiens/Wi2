<?php
    ...
    Class Component_webshop_Controller extends Login_Controller {
        ...
        public function savesettings($fieldid) {
            ...
            if (Wi3::$rights->check("edit", $field->page) == true) { //if one is allowed to edit the page of this field, it is allowed to edit settings of this field
