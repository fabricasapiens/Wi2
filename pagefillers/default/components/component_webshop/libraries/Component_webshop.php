<?php
    ...
    class Component_webshop extends Pagefiller_default_component {
        ...
        public function __construct() {
            ...
            $this->wi3_dependencies_plugins = array("Plugin_jquery_1_4_2_wi3", "Plugin_jquery_1_4_2_fancybox");
            if (Wi3::$editmode == true) {
                ...
                $this->wi3_dependencies_plugins = array( "Plugin_jquery_1_4_2_wi3", "Plugin_jquery_1_4_2_fancybox", "Plugin_tinymce");
                //load javascript that is needed for editing
                $this->javascript("edit.js");
            }
            //load javascript that is needed for webshoppin' !
            $this->javascript("webshop.js");
