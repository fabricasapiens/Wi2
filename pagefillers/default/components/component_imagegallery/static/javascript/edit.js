...
wi3.makeExist("wi3.pagefiller.components.component_imagegallery");
//now add our funtion(s) to this existing object(s)

wi3.pagefiller.components.component_imagegallery.selectfolder = function(folderid) {
    var prefix = "component_imagegallery";
    wi3.request(prefix + "/selectfolder/" + wi3.pagefiller.editing.currentFieldId, {folderid: folderid} );
    return false;
}   


wi3.pagefiller.components.component_imagegallery.initedit = function() {
    var prefix = "component_imagegallery";
...
/*
wi3.pagefiller.components.component_imagegallery.add = function() {
    var prefix = "component_imagegallery";
...
wi3.pagefiller.components.component_imagegallery.edit = function(id) {
    var prefix = "component_imagegallery";
    //show the edit form
...
wi3.pagefiller.components.component_imagegallery.saveedit = function(id) {
    var prefix = "component_imagegallery";
    //check for TinyMCE instances
...
wi3.pagefiller.components.component_imagegallery.moveup = function(elm) {
    var prefix = "component_imagegallery";
...
wi3.pagefiller.components.component_imagegallery.movedown = function(elm) {
    var prefix = "component_imagegallery";
    var parent = $(elm).closest("tr");
...
wi3.pagefiller.components.component_imagegallery.remove = function(id) {
    var prefix = "component_imagegallery";
