...
wi3.makeExist("wi3.pagefiller.components.component_picasaweblinks");
//now add our funtion(s) to this existing object(s)


wi3.pagefiller.components.component_picasaweblinks.initedit = function() {
    var prefix = "component_picasaweblinks";
...
wi3.pagefiller.components.component_picasaweblinks.add = function() {
    var prefix = "component_picasaweblinks";
...
wi3.pagefiller.components.component_picasaweblinks.edit = function(id) {
    var prefix = "component_picasaweblinks";
    //show the edit form
...
wi3.pagefiller.components.component_picasaweblinks.saveedit = function(id) {
    var prefix = "component_picasaweblinks";
    //check for TinyMCE instances
...
wi3.pagefiller.components.component_picasaweblinks.moveup = function(elm) {
    var prefix = "component_picasaweblinks";
...
wi3.pagefiller.components.component_picasaweblinks.movedown = function(elm) {
    var prefix = "component_picasaweblinks";
    var parent = $(elm).closest("tr");
...
wi3.pagefiller.components.component_picasaweblinks.remove = function(id) {
    var prefix = "component_picasaweblinks";
