...
<div id="<?php echo $prefix; ?>_edit_tabs">
	...
	<div id="<?php echo $prefix; ?>_edit_tabs-1">
        ...
        <h2>Nieuw element</h2><p>
                ...
                <tr><td> albumtitel </td><td> <input name='title' /></td></tr>
                <tr><td> albumlocatie </td><td> <input name='url' /></td></tr>
                <tr><td> tekst </td><td> <textarea name='text' /></td></tr>
    ...
    <div id="<?php echo $prefix; ?>_edit_tabs-2">
        <?php
           ...
           <table>
                <tr><td> albumnaam </td><td> <input name='title' /></td></tr>
                <tr><td> albumlocatie </td><td> <input name='url' /></td></tr>
                <tr><td> tekst </td><td> <textarea name='text' /></td></tr>
