        ...
        <?php
            ...
            function recursive($files, $currentid) {
                ...
                foreach($files as $file) {
                    if ($file->type == "folder") {
                        echo "<li " . ($file->id == $currentid ? "style='font-weight: bold;'" : "") . " id='".$prefix."_edit_li_" . $file->id . "'><a href='javascript:void(0);' onClick='wi3.pagefiller.components.".$prefix.".selectfolder(" . $file->id . ");'>" . $file->filename . "</a> (" . $file->fileDescendantsAmount . ")";
            ...
            echo "<ul><li " . ($file->id == $currentid ? "style='font-weight: bold;'" : "") . " id='".$prefix."_edit_li_0'><a href='javascript:void(0);' onClick='wi3.pagefiller.components.".$prefix.".selectfolder(" . $file->id . ");'>Alle afbeeldingen</a> (" . $file->fileDescendantsAmount . ")";
                recursive($file->children, $currentid);
            echo "</li></ul>";
