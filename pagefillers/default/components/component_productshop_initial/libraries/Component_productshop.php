    ...
    class Component_productshop extends Pagefiller_default_component {
        ...
        public function render_field($field) {
            ...
            if (!empty($folderid) AND $folderid > 0) {
                $items = Wi3::$files->find(Array("whereExt" => Array("jpg","png","gif","jpeg"), "whereFolder" => $folderid));
            } else {
                $items = Wi3::$files->find(Array("whereExt" => Array("jpg","png","gif","jpeg")));
            }
            $view = $this->view("view");
            $view->set("c", "component_productshop");
