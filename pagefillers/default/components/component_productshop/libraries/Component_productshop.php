<?php
    ...
    class Component_productshop extends Pagefiller_default_component {
        ...
        public $wi3_dependencies_plugins = array( "Plugin_jquery_1_4_2_wi3", "Plugin_jquery_1_4_2_fancybox"); //plugins that need to be loaded before this component can do its work
        ...
        public function __construct() {
            if (Wi3::$editmode == true) {
                ...
                $this->wi3_dependencies_plugins = array( "Plugin_jquery_1_4_2_wi3", "Plugin_jquery_1_4_2_ui", "Plugin_jquery_1_4_2_fancybox", "Plugin_tinymce");
                //load javascript that is needed for editing
                $this->javascript("edit.js");
            }
            $this->javascript("view.js"); // Always include the view.js
