 ...
 */
$config['site_domain'] = substr($_SERVER["PHP_SELF"], 0, strpos($_SERVER["PHP_SELF"], "index.php"));;
...
(
       ...
       MODPATH.'fabricaSapiens',
       MODPATH.'formo',
       
       APPPATH.'plugins/tinymce',
       APPPATH.'plugins/jquery',
       APPPATH.'plugins/clientjavascriptvars',
       
       APPPATH.'pagefillers/default',   //default pagefiller
